...
# 1. Class Task สำหรับจัดการข้อมูลงานแต่ละชิ้น
class Task:
...
# 2. Abstract Class TaskStorage (เป็น Interface ตามหลัก OCP)
...
# 3. Concrete Class FileTaskStorage สำหรับจัดการจัดเก็บข้อมูลลงไฟล์ (ตามหลัก SRP)
...
# 4. Class TaskManager (รับ storage เข้ามาด้วย Dependency Injection)
class TaskManager:
...
# 5. Logic หลักเพื่อทดสอบการทำงาน
